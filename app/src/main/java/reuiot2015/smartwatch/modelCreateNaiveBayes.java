...
public class modelCreateNaiveBayes {


    public static void main(String[] args) throws Exception {

        String inputName = "C:\\Users\\cha\\Desktop\\IOT2016\\model test folder\\walker data ReLabeled train.csv";
        String outputName = "C:\\Users\\cha\\Desktop\\IOT2016\\model test folder\\fallnaivemodel.model";
        String testDataName = "C:\\Users\\cha\\Desktop\\IOT2016\\model test folder\\10_10 watch only ADL.csv";
    ...
    //    LibSVM svm = new LibSVM();
        NaiveBayes modelNaive = new NaiveBayes();
    ...
    //    svm.buildClassifier(train);
        ...
        weka.core.SerializationHelper.write(outputName, modelNaive);

        //runs 5 fold crossvalidation on svm and prints results
        Evaluation eval = new Evaluation(train);
    //    eval.crossValidateModel(svm, train, 5, new Random(1));
        eval.crossValidateModel(modelNaive, train, 10, new Random(1));
        ...
        eval2.crossValidateModel(newsvm, testdata, 10, new Random(1));
